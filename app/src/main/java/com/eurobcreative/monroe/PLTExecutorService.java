...
import com.eurobcreative.monroe.util.AndroidWebView;
...
//			AndroidWebView spdyWebView=new AndroidWebView(this, false, startTimeFilter, url);
            AndroidWebView webView = new AndroidWebView(this, true, AndroidWebView.WebViewProtocol.HTTP, startTimeFilter, url);
            webView.loadUrl();
//			try {
//				Thread.sleep(50000);
...
//			httpWebView.loadUrl(url);
            ...
            AndroidWebView webView = new AndroidWebView(this, false, AndroidWebView.WebViewProtocol.HTTP, startTimeFilter, url);
            webView.loadUrl();
