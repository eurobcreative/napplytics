...
public class Util {
     ...
     */
    public static ArrayList<Double> applyInnerBandFilter(ArrayList<Double> vals, double lowerBound, double upperBound) throws InvalidParameterException {
        ...
        ArrayList<Double> finalRrtResults = new ArrayList<>();
