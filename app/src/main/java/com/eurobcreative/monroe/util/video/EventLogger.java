...
public class EventLogger implements DemoPlayer.Listener, DemoPlayer.InfoListener, DemoPlayer.InternalErrorListener {
    ...
    public static HashMap<Pair<Integer, Integer>, Integer> Resolution2Bitrate = new HashMap<>();
    public static HashMap<String, Integer> Id2Bitrate = new HashMap<>();
    ...
    public EventLogger() {
        ...
        this.dropFrameTime = new ArrayList<>();
        this.videoBitrateVarience = new ArrayList<>();
        this.audioBitrateVarience = new ArrayList<>();
        this.rebufferTime = new ArrayList<>();
        this.videoGoodput = new ArrayList<>();
        this.videoGoodputEstimate = new ArrayList<>();
        this.audioGoodput = new ArrayList<>();
...
//    this.goodput.add(Pair.create(getSessionTimeString(), (double)bytes * 8000 / elapsedMs));
    ...
    public void onVideoFormatEnabled(String formatId, int trigger, int mediaTimeMs) {
        ...
        Log.d(TAG, "videoFormat [" + getSessionTimeString() + ", " + formatId + ", " + Integer.toString(trigger) + ", " + currentBitrate / 1000 + "kbps" + "]");
        this.videoBitrateVarience.add(Pair.create(getSessionTimeString(), this.previousVideoBitrate));
    ...
    public void onAudioFormatEnabled(String formatId, int trigger, int mediaTimeMs) {
        int currentBitrate = Id2Bitrate.get(formatId);
        Log.d(TAG, "audioFormat [" + getSessionTimeString() + ", " + formatId + ", " + Integer.toString(trigger) + ", " + currentBitrate / 1000 + "kbps" + "]");
        this.audioBitrateVarience.add(Pair.create(getSessionTimeString(), this.previousAudioBitrate));
