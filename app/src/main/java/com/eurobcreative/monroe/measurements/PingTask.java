...
public class PingTask extends MeasurementTask {
    ...
    public static class PingDesc extends MeasurementDesc {
        ...
        public PingDesc(String key, Date startTime, Date endTime, double intervalSec, long count,
            ...
            super(PingTask.TYPE, key, startTime, endTime, intervalSec, count, priority, contextIntervalSec, params);
        ...
        protected void initializeParams(Map<String, String> params) {
            ...
            try {
                ...
                if ((val = params.get("ttl")) != null && val.length() > 0 && Integer.parseInt(val) > 0) {
                    this.pingTimeToLive = Integer.parseInt(val);
                }
                if ((val = params.get("icmp_interval_sec")) != null && val.length() > 0 && Double.parseDouble(val) > 0) {
        ...
        public static final Parcelable.Creator<PingDesc> CREATOR = new Parcelable.Creator<PingDesc>() {
    ...
    public static final Parcelable.Creator<PingTask> CREATOR = new Parcelable.Creator<PingTask>() {
    ...
    private MeasurementResult constructResult(ArrayList<Double> rrtVals, double packetLoss, int packetsSent, String pingMethod) {
    ...
    private MeasurementResult executeHttpPingTask() throws MeasurementError {
        long pingStartTime = 0;
        long pingEndTime = 0;
        ArrayList<Double> rrts = new ArrayList<>();
        PingDesc pingTask = (PingDesc) this.measurementDesc;
        String errorMsg = "";
        MeasurementResult result = null;
