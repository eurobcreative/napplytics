...
import com.eurobcreative.monroe.Checkin;
...
public class RRCTask extends MeasurementTask {
    ...
    public static class RRCDesc extends MeasurementDesc {
        ...
        public RRCDesc(String key, Date startTime, Date endTime, double intervalSec, long count,
            ...
            super(RRCTask.TYPE, key, startTime, endTime, intervalSec, count, priority, contextIntervalSec, params);
...
//      ClassLoader loader = Thread.currentThread().getContextClassLoader();
        ...
        protected void initializeParams(Map<String, String> params) {
            ...
            try {
                ...
                if ((val = params.get("default_extra_test_timers")) != null && val.length() > 0) {
                    ...
                    List<String> stringList = new ArrayList<>(Arrays.asList(timesString));
                    List<Integer> intList = new ArrayList<>();
                    Iterator<String> iterator = stringList.iterator();
                    while (iterator.hasNext()) {
                        intList.add(Integer.parseInt(iterator.next()));
                    }
                    times = intList.toArray(new Integer[intList.size()]);
    ...
    public static class RRCTestData {
        ...
        public void updateAll(int index, int rttMax, int rttMin, int numPacketsLostMax,
            ...
            this.rttsLarge[index] = rttMax;
            this.rttsSmall[index] = rttMin;
        ...
        try {
            ...
            if (e.getMessage().equals("Rescheduled")) {
                ...
                MeasurementResult result = new MeasurementResult(phoneUtils.getDeviceInfo().deviceId,
                        phoneUtils.getDeviceProperty(this.getKey()), RRCTask.TYPE, System.currentTimeMillis() * 1000,
                        TaskProgress.RESCHEDULED, this.measurementDesc);
            ...
            for (int i = 0; i < times.length; i++) {
                ...
                for (int j = 0; j < desc.GIVEUP_THRESHHOLD; j++) {
                    ...
                    */
                    ...
                    String url = "http://" + desc.target + "?dummy=" + i + "" + j;
     ...
     * @throws MeasurementError
     */
    private RRCDesc inferDemotion(InetAddress serverAddr, RRCDesc desc, RRCTestData data, PhoneUtils utils) throws InterruptedException, IOException, MeasurementError {
...
//      signalStrengthSmall = utils.getCurrentRssi();
        ...
        data.updateAll(index, (int) rttLargePacket, (int) rttSmallPacket, packetsLostSmall,
                packetsLostLarge, errorCountLarge, errorCountSmall, signalStrengthLarge, signalStrengthSmall);
