...
import com.eurobcreative.monroe.PLTExecutorService;
...
//	private long dataConsumed;
    ...
    public static class PageLoadTimeDesc extends MeasurementDesc {
        ...
        public PageLoadTimeDesc(String key, Date startTime, Date endTime, double intervalSec,
            ...
            super(PageLoadTimeTask.TYPE, key, startTime, endTime, intervalSec, count, priority, contextIntervalSec, params);
            initializeParams(params);
            if (this.url == null) {
                throw new InvalidParameterException("PageLoadTimeTask cannot be created due to null url string");
            }
        }
        ...
        public static final Parcelable.Creator<PageLoadTimeDesc> CREATOR = new Parcelable.Creator<PageLoadTimeDesc>() {
    ...
    public PageLoadTimeTask(MeasurementDesc desc) {
        super(new PageLoadTimeDesc(desc.key, desc.startTime, desc.endTime, desc.intervalSec, desc.count,
                desc.priority, desc.contextIntervalSec, desc.parameters));

        navigationTimingResults = new ArrayList<>();
        resourceTimingResults = new ArrayList<>();
...
//		dataConsumed=0;
    ...
    public MeasurementTask clone() {
        ...
        PageLoadTimeDesc newDesc = new PageLoadTimeDesc(desc.key, desc.startTime, desc.endTime,
